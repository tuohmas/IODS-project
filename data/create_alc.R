...
################################################################################
# Wrangling exercice for Week 3. Dataset is sourced from UCI Machine Learning  #
# Repository, Student Performance Data (incl. Alcohol consumption).            #
...
################################################################################
# Code taken from https://raw.githubusercontent.com/rsund/IODS-project/master/data/create_alc.R
# to achive data merging: ######################################################
...
join_by <- setdiff(colnames(por_id),free_cols)
...
# Now we have a dataset with 370 Observations and 48 variables
glimpse(pormath)
...
# write data to a semicilon separated csv-file
write.table(alc, "alc.csv", sep = ";", row.names = F, col.names = T)
